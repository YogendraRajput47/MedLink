...
const RelatedDoctors = ({ docId, speciality }) => {
  ...
  }, [doctors, docId, speciality]); // <-- include `doctors` here
  ...
  return (
    ...
    relatedDoc.length > 0 && (
      <div
        ref={topRef}
        className="flex w-full flex-col items-center gap-4 my-5 text-gray-900 md:mx-10 mt-20"
      >
        ...
        <div className="w-full  flex flex-wrap  gap-4 pt-5 px-3 gap-y-6 sm:px-0 place-content-center ">
          {relatedDoc.slice(0, 5).map((doctor, index) => (
            ...
            >
              <img
                className="bg-blue-50 w-64 hover:bg-blue-100 transition-all duration-300"
                src={doctor.image}
                alt=""
              />
              <div className="p-4">
